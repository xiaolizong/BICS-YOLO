...
def yaml_save(file='streeview.yaml', data=None, header=''):
    """
    Save YAML data to a file.

    Args:
        file (str, optional): File name. Default is 'streeview.yaml'.
...
def yaml_load(file='streeview.yaml', append_filename=False):
    """
